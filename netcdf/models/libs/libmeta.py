...
dir_prod    = "/DATA/cylc/products" #os.environ['PRODUCTS']    #_Location for model outputs
...
#def current_icap(): return ['MACC','GEOS5','NAAPS','MASINGAR','NGAC','NMMB','UKMO'][:]
def current_icap(): return ['CAMS','GEOS5','NAAPS','MASINGAR','NGAC','MONARCH','UKMO'][:]
#def current_icap(): return ['CAMS'][:]
#def allspecie_icap(): return ['MACC','GEOS5','NAAPS','MASINGAR'][:]
def allspecie_icap(): return ['CAMS','GEOS5','NAAPS','MASINGAR'][:]
#def allspecie_icap(): return ['CAMS'][:]


def models():
    '''returns dictionary of expected metadata for all models'''
    f = {}
    [ f.update( { k : v } ) for k,v in ensemble_models().items() ]
    [ f.update( { k : v } ) for k,v in deterministic_models().items() ]
    return f
...
def deterministic_models():
    ...
    TODO:    Consolidate dict.keys(), name, and dir.  Get rid of all the
        ...
        models  = {     'ARP_JAXA_ptree' : {
                                     ...
                                     'timeRegex' : ".*?_(\d+_\d+)_.*",
                                     'path' : '/shared/aerosol_sat/geo/l3/ahi/ARP_JAXA_ptree/030/dtg/daily',
                                    }, 
                        'NAVGEM_05'   : {   'label'  : 'NAVGEM',
                                        'numberlabel' : ' 1 ',
                                        'field' : 'aod',
                                        'fields'  : 'discover',
                                        'fieldType' : 'discover',
                                        'prefix': '',
                                        'path' : '/DATA/cylc/products/NAVGEM_05/dtg/',
                                        'color' : 'black',
                        ...
                        'ENAAPS':  {'label'  :'ENAAPS',
                                    ...
                                    'legend':'NAAPS Ens $\mu$',
                                    'prefix':'DART Ensemble ',
                                    'path' : '/DATA/cylc/products/ENAAPS/dtg/',
                                    'specn' : {'total_aod'   : 'total_aod',
                                                   'sulfate_aod' : 'sulfate_aod',
                                                   'smoke_aod'   : 'smoke_aod',
                                                   'seasalt_aod' : 'seasalt_aod',
                                                   'dust_aod'    : 'dust_aod'},
                                    'specs' : ['total_aod','sulfate_aod','smoke_aod','seasalt_aod','dust_aod'],
                                    'color' : 'red',
                                    'foot'  :'NOT OFFICIAL FNMOC NAAPS RUN',
                                    'web'   :'ens_01',     #used to be 'dart_01'
                                    'dir'   : 'ENAAPS',
                                  },
                        'NAAPS_KORUS'   : {  'label'  : 'NAAPS_KORUS',
                                        'numberlabel' : ' 15 ',
                                        'prefix': '',
                                        'specs' : ['sulfate_aod','dust_aod',
                                                  'smoke_aod','seasalt_aod',
                                   ...
                                   'fcst_finc'  : 12,
                                        'finc'  : 3     },
                        'NAAPS_KORUS3D'   : {  'label'  : 'NAAPS_KORUS3D',
                                        'numberlabel' : ' 16 ',
                                        'field' : 'aod',
                                        'prefix': '',
                                        'specs' : ['sulfate_aod','dust_aod',
                        ...
                        'GEOS5' : {     'label'  : 'GEOS-5',
                                        ...
                                        'dir'   : 'GEOS5',
                                         'fhr'    : 120,
                                        'fcst_finc'    : 24,
                                         'path' : '/DATA/cylc/products/GEOS5/dtg/',
                                        'finc'  : 1 },
                        'CAMS' : {      'label'  : 'CAMS',
                                        'numberlabel' : ' 30 ',
                                        ...
                                        'dir'   : 'CAMS',
                                        'fhr'   : 120,
                                        'path' : '/DATA/cylc/products/CAMS/dtg/',
                                        'fcst_finc'  : 24,
                                        'finc'  : 3     },
                        'MOCAGE' : {      'label'  : 'MOCAGE',
                                        'numberlabel' : ' 8 ',
                                        ...
                                        'specs' : ['sulfate_aod','dust_aod',
                                                  'smoke_aod','seasalt_aod',
                                                  'total_aod'],
                                        'specn' : {'AOD_DESDUS' : 'AOD_DESDUS',
                                                   'AOD_BLACKC' : 'AOD_BLACKC',
                                                   'AOD_DYNSAL' : 'AOD_DYNSAL',
                                                   'AOD_ORGANC' : 'AOD_ORGANC',
                                                   'AOD_SULFAT' : 'AOD_SULFAT',
                                                   'AOD_NITRAT' : 'AOD_NITRAT',
                                                   'AOD_AMMONI' : 'AOD_AMMONI',
                                                   'AOD_AnthFinePart' : 'AOD_AnthFinePart',
                                                   'AOD_smoke' : 'AOD_smoke',
                                                   'AOD' : 'AOD'},
                                        'color' : 'orange',
                                        'foot'  : '',
                                        ...
                                        'fhr'   : 96,
                                        'fcst_finc'  : 24,
                                        'path' : '/DATA/cylc/products/MOCAGE/dtg/',
                                        'finc'  : 6     },
                        'SILAM_SFC' : { 'label'  : 'SILAM',
                                        'hasHybrid' : True,
                                        'numberlabel' : ' 9 ',
                                        'field' : 'sfc',
                                        'prefix': '',
                                        'specs' : ['Seasalt_SFC','Dust_SFC',
                                                  'PM10','PM2.5'],
                                        'specn' : {'seasalt_sfc'   : 'cnc_sslt',
                                                   'dust_sfc'      : 'cnc_dust',
                                                   'pm2.5'         : 'cnc_PM2_5',
                                                   'pm10'          : 'cnc_PM10'},
                                        'color' : 'orange',
                                        ...
                                        'fhr'   : 120,
                                        'fcst_finc'  : 24,
                                        'path' : '/DATA/cylc/products/SILAM_SFC/dtg/',
                                        'finc'  : 6     },
                        'SILAM_AOD' : {      'label'  : 'SILAM',
                                        'numberlabel' : ' 9 ',
                                        'field' : 'aod',
                                        'prefix': '',
                                        'specs' : ['sulfate_aod','dust_aod',
                                                  'smoke_aod','seasalt_aod',
                                                  'total_aod'],
                                        'specn' : {'total_aod'   : 'ocd_part_w550',
                                                   'sulfate_aod' : 'ocd_abf_w550',
                                                   'smoke_aod'   : 'ocd_frp_w550',
                                                   'seasalt_aod' : 'ocd_sslt_w550',
                                                   'dust_aod'    : 'ocd_dust_w550'},
                                        'color' : 'orange',
                                        'foot'  : '',
                                        'web'   : 'silam_01',
                                        'dir'   : 'SILAM',
                                        'fhr'   : 120,
                                        'fcst_finc'  : 24,
                                        'path' : '/DATA/cylc/products/SILAM_AOD/dtg/',
                                        'finc'  : 6     },
                        'MASINGAR' : {  'label'  : 'MASINGAR',
                                        ...
                                        'web'   : 'masingar_01',
                                        'dir'   : 'MASINGAR',
                                        'path' : '/DATA/cylc/products/MASINGAR/dtg/',
                                        'finc'  : 6     },
                        'NGAC' : {      'label'  : 'NGAC',
                                        'numberlabel' : ' 5 ',
                                        'field' : 'aod',
                                        ...
                                        'fhr'    : 120,
                                        'fcst_finc'    : 24,
                                        'path' : '/DATA/cylc/products/NGAC/dtg/',
                                        'finc'  : 6     },
                        'NGACF' : {      'label'  : 'NGAC',
                                        'numberlabel' : ' 50 ',
                                        'field' : 'aod',
                                        ...
                                        'specn' : {'dust_aod' : 'dust_aod',
                                                   'seasalt_aod' : 'seasalt_aod',
                                                   'BlackCarbon_AOD' : 'BlackCarbon_AOD',
                                                   'sulfate_aod' : 'sulfate_aod',
                                                   'OrganicCarbon_AOD' : 'OrganicCarbon_AOD' ,
                                                   'total_aod' : 'total_aod'},
                                        'color' : 'blue',
                                        'foot'  : '',
                                        'web'   : 'ngac_02',
                                        'dir'   : 'NGACF',
                                        'path' : '/DATA/cylc/products/NGACF/dtg/',
                                         'fhr'  : 120,
                                   'fcst_finc'  : 24,
                                        'finc'  : 3     },
                        'UKMO' : {      'label'  : 'UKMO',
                                        ...
                                        'prefix': '',
                                        'specn' : { 
                                             'dust_aod' : 'atmosphere_optical_thickness_due_to_dust_dry_aerosol'
                                         },
                                        'specs' : ['dust_aod'],
                                        'color' : 'pink',
                                        'foot'  : '',
                                        ...
                                        'fcst_finc'  : 24,
                                        'finc'  : 3,
                                        'path' : '/DATA/cylc/products/UKMO/dtg/',
                                        'timeIsTimestamp' : True,
                                        'timeIsHoursSince' : True},
                        'MONARCH' : {'label'  : 'MONARCH',
                                        ...
                                        'dir'   : 'MONARCH',
                                        'fhr'   : 120,
                                        'path' : '/DATA/cylc/products/MONARCH/dtg/',
                                        'fcst_finc'  : 24,
                                        'finc'  : 6     }, 
                        'NMMB-MONARCH' : {'label'  : 'MONARCHF',
                                        'numberlabel' : ' 16 ',
                                        'field' : 'aod',
                                        'prefix': '',
                                        'specs' : ['sulfate_aod','dust_aod',
                                                  ...
                                                  'total_aod'],
                                        'specn' : { 
                                                 'dust_aod550'  : 'dust_aod550',
                                                 'salt_aod550'  : 'salt_aod550',
                                                 'smoke_aod550' : 'smoke_aod550',
                                                 'abf_aod550'   : 'abf_aod550',
                                                 'total_aod550' :  'total_aod550'
                                                  },
                                        'color' : 'brown',
                                        'foot'  : '',
                                        'web'   : 'monarchf_01',
                                        'dir'   : 'MONARCH',
                                        'fhr'   : 120,
                                        'path' : '/DATA/cylc/products/NMMB-MONARCH/dtg/',
                                        'fcst_finc'  : 24,
                                        'finc'  : 6     }
                       }
        return models
...
def fields():
    f = {}
    [ f.update( { k : v } ) for k,v in fields_det().items() ]
    [ f.update( { k : v } ) for k,v in fields_ens().items() ]
    return f
...
def fields_det():
    ...
    fields    = {
                 'obs'      : {
                    'levs' : [.1,.2,.4,.8,1.2,2.5,5.,9.],
                    'colors'   : lt.rgbgen('aod'),
                    'level'    : 'aod',
                    'title'    :'Observational' 
                 } ,
                 'sfc'      : {
                    'levs' : [15,35,60,100,150,300,600,1000],
                    'colors'   : lt.rgbgen('sfc'),
                    'level'    : 'sfc',
...
def ieee_vars( nz, ny, nx ):
    vars    = {    'so2'    : {
            ...
            'so2_aod': {
                ...
                'units'        : '1',
                '_FillValue'    : '-999',
                'long_name'    : 'so2 aerosol optical depth at 550nm'},
            'sulfate_aod': {
                'dims'        : ('lat','lon'),
                'shape'        : (ny,nx),
                'units'        : '1',
            ...
            'smoke_aod': {
                ...
                'units'        : '1',
                '_FillValue'    : '-999',
                'long_name'    : 'smoke aerosol optical depth at 550nm'},
            'seasalt_aod': {
                'dims'        : ('lat','lon'),
                'shape'        : (ny,nx),
                'units'        : '1',
...
def site2code():
    ...
    out = {}
    for c, m in aeronet_points().items(): out.update({ m[1] : c })
    return out
